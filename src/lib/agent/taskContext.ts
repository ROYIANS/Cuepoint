...
export async function getTaskContext(threadId: string | undefined, instructions: string, taskMode = false, interactionMode: AgentInteractionMode = "smart") {
  ...
  return { instructions: assembled, task, records, taskToolNames };
}
