...
const submitParameters={type:"object",additionalProperties:false,required:["connectorId","model","target","prompt"],properties:{
  ...
  parameters:{type:"object",additionalProperties:false,properties:{size:{type:"string",description:'图片尺寸：APIMart 使用比例，例如 9:16；AIHubMix 使用已支持的像素尺寸。'},resolution:{type:"string"},duration:{type:"integer"},aspectRatio:{type:"string",description:"仅视频使用；图片比例使用 size。"},mode:{type:"string",enum:["text","frames","reference"],description:"仅视频使用；图片不要传入。"},quality:{type:"string",enum:["low","medium","high","xhigh","max","auto"]},version:{type:"string",enum:["flare","sunburst"]}}},
