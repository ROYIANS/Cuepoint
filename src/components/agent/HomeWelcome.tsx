      ...
      <div className="agent-home">
        <div className="agent-home-inner">
          <div className="agent-home-hero">
            <Avatar className="home-grainient-logo" avatar={LOGO_SRC} background="transparent" shape="square" size={64} />
            <Text
              as="h1"
              style={{
                margin: 0,
          ...
          {composer.chatMode === "task" ? (
            ...
            <div style={{ marginTop: 24, textAlign: "start" }}>
              ...
              {recent.map((thread) => (
                ...
                >
                  <Avatar className="home-grainient-logo" avatar={LOGO_SRC} background="transparent" shape="circle" size={22} />
                  <div
                    style={{
                      flex: 1,
                      minWidth: 0,
