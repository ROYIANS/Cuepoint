...
const skills = ["project-references", "project-memory", "workspace", "planning", "business-read", "story-edit", "asset-edit", "media-generation"];

describe("foundational skill defaults", () => {
  it("persists all eight defaults for new installations", async () => {
